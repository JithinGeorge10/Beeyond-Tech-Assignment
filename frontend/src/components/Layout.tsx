...
import { ShoppingCart, Package, User, LogOut, Bell } from 'lucide-react';
      ...
      <header className="bg-white border-b shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <NavLink to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl">Quick Commerce</span>
          </NavLink>
          ...
          <div className="flex items-center gap-4">
            {isAuthenticated && (
              <>
                ...
                <NavLink to="/orders" className="text-gray-700 hover:text-brand-purple">
                  Orders
                </NavLink>
      ...
      <footer className="bg-brand-dark text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-bold mb-4">Quick Commerce</h3>
              <p className="text-gray-300 text-sm">
                Fast, reliable delivery for all your needs.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
            <p>&copy; 2025 Beeyond Tech. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
